...
class Top extends React.Component {
  constructor(props) {
    ...
    this.state = {
      createFacultyModalActive: false,  // Whether or not the create Faculty modal should show
    }
  ...
  getDataList() {
    this.props.getDataList('faculties', 'schools');
  }

  // Show/hide the create Faculty modal
  toggleCreateFacultyModal(e) {
    this.setState({
