...
class Top extends React.Component {
  constructor(props) {
    ...
    this.state = {
      createEquipmentModalActive: false,  // Whether or not the create Equipment modal should show
    }
  ...
  // Show/hide the create Equipment modal
